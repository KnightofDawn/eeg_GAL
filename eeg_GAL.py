...
class EEG_rnn_batch():
    ...
    def select_model(self, model_name):
        ...
        def seq_to_seq():
            ...
            model.add(TimeDistributedDense(64,12)) # output shape: (nb_samples, nb_timesteps, 9)
...
if __name__ == '__main__':
    ...
    run_model_kin_generator(model_name='seq_to_seq', participator=1, timesteps=10, stride=100, nb_epoch=100)
    run_model_kin_generator(model_name='seq_to_seq', participator=1, timesteps=50, stride=100, nb_epoch=100)
    run_model_kin_generator(model_name='seq_to_seq', participator=1, timesteps=10, stride=10, nb_epoch=100)
    run_model_kin_generator(model_name='seq_to_seq', participator=1, timesteps=10, stride=5, nb_epoch=100)
